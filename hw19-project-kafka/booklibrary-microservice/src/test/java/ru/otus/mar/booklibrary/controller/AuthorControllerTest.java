...
public class AuthorControllerTest {
    ...
    public void list() throws Exception {
        ...
        mvc.perform(get("/api/library/author").with(MOCK_JWT))
                .andDo(print())
    ...
    public void apiPost() throws Exception {
        ...
        mvc.perform(post("/api/library/author")
                        .with(MOCK_JWT)
    ...
    public void apiPut() throws Exception {
        ...
        mvc.perform(put("/api/library/author/" + AUTHOR_DTO.getId())
                        .with(MOCK_JWT)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(mapper.writeValueAsString(AUTHOR_DTO)))
                .andDo(print())
    ...
    public void apiDelete() throws Exception {
        mvc.perform(delete("/api/library/author/" + AUTHOR_DTO.getId())
                        .with(MOCK_JWT)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(mapper.writeValueAsString(AUTHOR_DTO)))
                .andDo(print())
